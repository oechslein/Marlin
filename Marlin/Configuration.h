...
#define FILAMENT_RUNOUT_SENSOR  // CO Enabled
  ...
  #define FIL_RUNOUT_INVERTING true // CO was false // Set to true to invert the logic of the sensor.
...
#define Z_SAFE_HOMING // CO enabled
  ...
  // X_PROBE_OFFSET_FROM_EXTRUDER and Y_PROBE_OFFSET_FROM_EXTRUDER already subtracted in code
    #define Z_SAFE_HOMING_X_POINT ((X_MIN_POS + X_MAX_POS) / 2)    // CO was (((X_BED_SIZE) / 2) + X_PROBE_OFFSET_FROM_EXTRUDER) // X point for Z homing when homing all axes (G28).
    #define Z_SAFE_HOMING_Y_POINT ((Y_MIN_POS + Y_MAX_POS) / 2)    // CO was (((Y_BED_SIZE) / 2) + Y_PROBE_OFFSET_FROM_EXTRUDER) // Y point for Z homing when homing all axes (G28).
  // #endif
#endif
