...
#define STRING_CONFIG_H_AUTHOR "(CO, Ender-3 Pro SKR1.3)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 -1 // CO Enabled/Changed for SKR
 ...
 */
#define BAUDRATE 115200  // CO Enabled/Changed for SKR
...
#define MACHINE_UUID "964ccbb2-226d-4abc-9ebb-c91b4bb58daa" // CO created
...
#define HEATER_0_MINTEMP   12 // CO 12C should never occur (default: 5)
...
#define BED_MINTEMP        12 // CO 12C should never occur (default: 5)

// Above this temperature the heater will be switched off.
// This can protect components from overheating, but NOT from shorts and failures.
// (Use MINTEMP for thermistor short/failure protection.)
#define HEATER_0_MAXTEMP 290 // CO was 275
 ...
 */
#define PIDTEMPBED // CO enabled (klipper has it enabled per default)
...
#define EXTRUDE_MAXLENGTH 500 // CO was 200
 ...
 */
#define X_DRIVER_TYPE  TMC2209 // CO
#define Y_DRIVER_TYPE  TMC2209 // CO
#define Z_DRIVER_TYPE  TMC2209 // CO
//#define X2_DRIVER_TYPE A4988
//#define Y2_DRIVER_TYPE A4988
#define Z2_DRIVER_TYPE TMC2209 // CO DUAL // STILL NEEDED?
//#define Z3_DRIVER_TYPE A4988
#define E0_DRIVER_TYPE TMC2209 // CO
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 415 } // CO, back to 415 after calibration with hotend // CO changed e-steps from 415 to 406 // CO Ender-3 Pro, default { 80, 80, 400, 93 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.06 // CO TODO Chris set to 0.01! // CO Calculated 0.4 * JERK_XY^2 / DEFAULT_ACCELERATION // (mm) Distance from real junction edge
 ...
 */
#define BLTOUCH // CO Enabled
// #define SERVO0_PIN       X_MIN_PIN // CO was P2_00 (SERVO Pin) is P1_29 X_MIN_PIN
 ...
 */
// Bullseye
// #define NOZZLE_TO_PROBE_OFFSET {-48, -7, -2.968}
...
#define Z_PROBE_SPEED_FAST (15*60) // CO was HOMING_FEEDRATE_Z
...
#define Z_CLEARANCE_BETWEEN_PROBES  10 // CO was 5 // Z Clearance between probe points
...
#define Z_MIN_PROBE_REPEATABILITY_TEST // CO Enabled
...
#define E_ENABLE_ON 0 // CO TODO set to 1 for ST820 // For all extruders
...
#define X_HOME_DIR -1
#define Y_HOME_DIR -1
#define Z_HOME_DIR -1 // CO DUAL SENSORLESS Z
...
#define Z_MAX_POS 227 // CO was 250
...
#define AUTO_BED_LEVELING_UBL // CO Enabled
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 // CO enabled
...
#define DEBUG_LEVELING_FEATURE // CO enabled from FB
   ...
   */
  #define G26_MESH_VALIDATION // CO Enabled
  ...
  #define GRID_MAX_POINTS_X 4 // CO from FB (default 3)
 ...
 */
#define LCD_BED_LEVELING // CO enabled
...
//
#define Z_SAFE_HOMING // CO enabled

#if ENABLED(Z_SAFE_HOMING)
  // AUTO_BED_LEVELING_UBL defines Z_SAFE_HOMING_X_POINT as (((GRID_MAX_POINTS_X) / 2) * (X_BED_SIZE - 2 * (MESH_INSET)) / (GRID_MAX_POINTS_X - 1) + MESH_INSET)
  // CO I like the middle more! #if DISABLED(AUTO_BED_LEVELING_UBL)
  // X_PROBE_OFFSET_FROM_EXTRUDER and Y_PROBE_OFFSET_FROM_EXTRUDER already subtracted in code
  #define Z_SAFE_HOMING_X_POINT ((X_MIN_POS + X_MAX_POS) / 2)    // CO was (((X_BED_SIZE) / 2) + X_PROBE_OFFSET_FROM_EXTRUDER) // CO was X_CENTER // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT ((Y_MIN_POS + Y_MAX_POS) / 2)    // CO was (((Y_BED_SIZE) / 2) + Y_PROBE_OFFSET_FROM_EXTRUDER) // CO was Y_CENTER // Y point for Z homing when homing all axes (G28).
#endif

// Homing speeds (mm/min)
#define HOMING_FEEDRATE_XY (30*60) // CO was (50*60), reduced to improve senorless homing // CO from Teching Tech video, default: (20*60)
#define HOMING_FEEDRATE_Z  (20*60) // CO from Teching Tech video, default: (4*60)
 ...
 */
#define EEPROM_SETTINGS // CO enabled // Enable for M500 and M501 commands
 ...
 */
#define NOZZLE_PARK_FEATURE // CO enabled
 ...
 */
//#define NOZZLE_CLEAN_FEATURE // CO it is cleaning without extrusion!! // CO Enabled
 ...
 */
#define PRINTCOUNTER // CO enabled
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU // CO enabled
...
//
#define SPEAKER
//#undef BEEPER_PIN  // CO Disabled for SKR
//#define BEEPER_PIN -1 // CO Disable buzzer as well
...
#define FAN_SOFT_PWM // CO Enabled
...
//#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN    P2_00 // CO it is the SERVO0_PIN normally used for bltouch!!, was 4        // LED driving pin
  //#define NEOPIXEL2_TYPE NEOPIXEL_TYPE
  //#define NEOPIXEL2_PIN    5
  #define NEOPIXEL_PIXELS 30       //CO need to adjust // Number of LEDs in the strip, larger of 2 strips if 2 neopixel strips are used
  #define NEOPIXEL_IS_SEQUENTIAL   // Sequential display for temperature change - LED by LED. Disable to change all LEDs at once.
  #define NEOPIXEL_BRIGHTNESS 127  // Initial brightness (0-255)
  #define NEOPIXEL_STARTUP_TEST  // CO Enabled // Cycle through colors at startup
